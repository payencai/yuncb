    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String phone = mXEditText.getEditableText().toString().trim();
                if(TextUtils.isEmpty(phone)){
                    ToastUtil.showToast(BindPhoneActivity.this,"手机号不能为空");
                    return;
                }
                if(phone.length()<11){
                    ToastUtil.showToast(BindPhoneActivity.this,"手机号格式不正确");
                    return;
                }
                checkIsExists(phone);
