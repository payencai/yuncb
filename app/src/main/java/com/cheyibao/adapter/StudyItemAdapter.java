...
public class StudyItemAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = LayoutInflater.from(mContext).inflate(R.layout.item_home_school, null);
        ...
        ScaleRatingBar simpleRatingBar = (ScaleRatingBar) convertView.findViewById(R.id.sb_score);
        ...
        address.setText(drvingSchool.getProvince()+drvingSchool.getCity()+drvingSchool.getDistrict()+drvingSchool.getAddress());
