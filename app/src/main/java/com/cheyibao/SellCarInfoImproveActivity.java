...
public class SellCarInfoImproveActivity extends NoHttpFragmentBaseActivity implements OnDateSetListener {
    ...
    private boolean checkInput() {
        ...
        if (TextUtils.isEmpty(et_name.getEditableText().toString().trim())) {
            isOk = false;
            ToastUtil.showToast(this, "姓名输入不能为空！");
            return isOk;
        }
        if (TextUtils.isEmpty(et_phone.getEditableText().toString())) {
            isOk = false;
            ToastUtil.showToast(this, "手机号输入不能为空！");
            return isOk;
        }
        ...
        if (TextUtils.isEmpty(et_num.getEditableText().toString())) {
            isOk = false;
            ToastUtil.showToast(this, "次数输入不能为空！");
            return isOk;
        }
    ...
    public void postData() {
        ...
        params.put("oldPrice", Double.parseDouble(b_price)*10000);
        ...
        params.put("lastValidateCar", time1Text.getText().toString()+"-01 00:00:00");
        params.put("registrationTime", b_time + "-01 00:00:00");
