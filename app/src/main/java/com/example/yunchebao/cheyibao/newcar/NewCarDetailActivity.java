    ...
    private void initView() {
        ...
        tv_buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(MyApplication.isLogin){
                    RongIM.getInstance().startPrivateChat(NewCarDetailActivity.this, merchant.getId(), "123"+"|"+merchant.getName());
                }
                else{
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                  Intent intent=new Intent(NewCarDetailActivity.this,NearShopActivity.class);
                  intent.putExtra("id",mNewCar.getCarCategoryDetailId());
                  startActivity(intent);
            }
        });
        if(mNewCar!=null){
