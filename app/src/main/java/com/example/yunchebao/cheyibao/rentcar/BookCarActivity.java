...
public class BookCarActivity extends AppCompatActivity {
    ...
    private LoadDataType loadDataType = new LoadDataType() {
        ...
        public Map<String, Object> initParam() {
            ...
            String telephone = contactPersonPhoneEt.getText().toString().trim();
            ...
            String callTelephone = emergencyContactPhoneEt.getText().toString().trim();
            ...
            if(callTelephone.equals(telephone)){
                ToastUtil.showToast(context,"2个手机号不能一样！");
                return null;
            }
            if(callName.equals(name)){
                ToastUtil.showToast(context,"紧急联系人和姓名不能相同");
                return null;
            }
            if(carMeal!=null){
