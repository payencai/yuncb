...
public class AddOrderCommentActivity extends AppCompatActivity {
    ...
    private void addComment() {
        ...
        params.put("shopScore", new BigDecimal(shopScore+"").setScale(0, BigDecimal.ROUND_HALF_UP));
        params.put("driverScore", new BigDecimal(driverScore+"").setScale(0, BigDecimal.ROUND_HALF_UP));
