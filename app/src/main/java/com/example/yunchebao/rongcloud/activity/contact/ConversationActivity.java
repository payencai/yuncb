...
import com.example.yunchebao.cheyibao.newcar.AddShopCommentActivity;
...
public class ConversationActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        rl_comment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ConversationActivity.this, AddShopCommentActivity.class);
                intent.putExtra("id", targetId);
                startActivity(intent);
            }
        });
