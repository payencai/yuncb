        ...
        HttpProxy.obtain().get(PlatformContans.GoodInfo.getBabyMerchantShopResultById, params, new ICallBack() {
            ...
            public void OnSuccess(String result) {
                try {
                    ...
                    LatLng latLng = new LatLng(Double.parseDouble(mGoodsShop.getLatitude()), Double.parseDouble(mGoodsShop.getLongitude()));
                    float distance = AMapUtils.calculateLineDistance(latLng, latLng2)/1000;
                    tv_dis.setText( MathUtil.getDoubleTwo(distance) + "km");
            ...
            public void OnSuccess(String result) {
                ...
                try {
                    ...
                    if(code==0){
                        ...
                        ToastUtils.showLongToast(ShopMainListActivity.this,message);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
