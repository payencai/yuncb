    ...
    private void initView(){
        ...
        lv_goods.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                PhoneOrderEntity.ItemListBean itemListBean=itemListBeans.get(position);
                GoodList goodList= new GoodList();
                goodList.setId(itemListBean.getCommodityId());
                goodList.setName(itemListBean.getCommodityName());
                Bundle bundle=new Bundle();
                bundle.putSerializable("data",goodList);
                ActivityAnimationUtils.commonTransition(GoodsOrderDetailActivity.this, GoodDetailActivity.class, ActivityConstans.Animation.FADE,bundle);
            }
        });
